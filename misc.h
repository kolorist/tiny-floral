...
// opaque struct, ref: https://stackoverflow.com/questions/3965279/opaque-c-structs-various-ways-to-declare-them
struct native_surface_t;
typedef struct native_surface_t native_surface_t;

#if defined(FLORAL_PLATFORM_WINDOWS)
struct native_surface_windows_t
{
	HINSTANCE									hInst;
	HWND										hwnd;
};
#elif defined(FLORAL_PLATFORM_ANDROID)
struct native_surface_android_t
{
	ANativeWindow*								wnd;
};
#endif
